package com.shanjing.hotattention.photoPicker;
...
import com.shanjing.hotattention.view.ViewPagerFixed;
...
public class BigImagePagerActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_hot_image_pager);
