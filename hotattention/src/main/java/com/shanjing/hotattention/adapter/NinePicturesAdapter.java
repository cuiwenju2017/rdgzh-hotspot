...
import com.shanjing.hotattention.photoPicker.BigImagePagerActivity;
import com.shanjing.hotattention.utils.ImageLoaderUtils;
import com.shanjing.hotattention.utils.ViewHolderUtil;
...
public class NinePicturesAdapter extends BaseAblistViewAdapter<String> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (TextUtils.isEmpty(url) && showAdd) {
            ImageLoaderUtils.display(mContext, imageView, R.drawable.bt_add_media);
