 ...
 * 我的评论适配器
 */
public class RecycleMyCommentAdapter extends RecyclerView.Adapter<RecycleMyCommentAdapter.ViewHolder> {
    ...
    public RecycleMyCommentAdapter(Context context, List<CommentListBean.DataBean> list) {
    ...
    @NonNull
    @Override
    public RecycleMyCommentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_my_like, null, false);
        RecycleMyCommentAdapter.ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final RecycleMyCommentAdapter.ViewHolder viewHolder, final int i) {
        viewHolder.tv_title.setText(list.get(i).getTitle());
        viewHolder.tv_content.setText(list.get(i).getContext());
        /**
         * 视屏适配器
         */
