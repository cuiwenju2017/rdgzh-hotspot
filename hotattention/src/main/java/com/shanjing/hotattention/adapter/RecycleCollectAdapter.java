 ...
 * 我的收藏适配器
 */
public class RecycleCollectAdapter extends RecyclerView.Adapter<RecycleCollectAdapter.ViewHolder> {
    ...
    public RecycleCollectAdapter(Context context, List<CollectListBean.DataBean> list) {
    ...
    @NonNull
    @Override
    public RecycleCollectAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_my_like, null, false);
        RecycleCollectAdapter.ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final RecycleCollectAdapter.ViewHolder viewHolder, final int i) {
        ...
        viewHolder.iv_pop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new HotHomePopWindow(context, list.get(i).getMember_id(), list.get(i).getResouce_id(),
