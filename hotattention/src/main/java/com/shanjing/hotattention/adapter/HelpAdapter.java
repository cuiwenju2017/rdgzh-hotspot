...
public class HelpAdapter extends RecyclerView.Adapter<HelpAdapter.ViewHolder> {
    ...
    private List<HelpListBean.DataBean> list;
    private GalleryAdapter galleryAdapter;

    public HelpAdapter(Context context, List<HelpListBean.DataBean> list) {
    ...
    public HelpAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        HelpAdapter.ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }

    private LoadingDialog loadingDialog;
    private List<HelpcountBean.DataBean> list2 = new ArrayList<>();
    Gson gson = new Gson();

    @Override
    public void onBindViewHolder(@NonNull final HelpAdapter.ViewHolder viewHolder, final int i) {
        ...
        RxHttpUtils
                ...
                .getHelpcount(body)
                .compose(Transformer.<HelpcountBean>switchSchedulers(loadingDialog))
                .subscribe(new Observer<HelpcountBean>() {
                    @Override
                    ...
                    @Override
                    public void onNext(HelpcountBean helpcountBean) {
                        viewHolder.tv_count.setText(helpcountBean.getData().get(0).getCount() + "人回答了问题");
                    }
