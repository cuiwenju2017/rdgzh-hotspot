...
import com.shanjing.hotattention.adapter.HelpAdapter;
...
public class HelpActivity extends BaseActivity implements View.OnClickListener {
    ...
    private List<HelpListBean.DataBean> list = new ArrayList<>();

    private void initData() {
        RxHttpUtils
                .createApi(HotService.class)
                .getHelpList(id, 1)
                .compose(Transformer.<HelpListBean>switchSchedulers(loadingDialog))
                .subscribe(new Observer<HelpListBean>() {
                    @Override
                    ...
                    public void onError(Throwable e) {
                        ToastUtil.showShort(HelpActivity.this, "" + e);
                    }
