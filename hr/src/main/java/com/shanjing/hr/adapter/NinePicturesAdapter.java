...
import com.shanjing.hr.photoPicker.BigImagePagerActivity;
import com.shanjing.hr.utils.ImageLoaderUtils;
import com.shanjing.hr.utils.ViewHolderUtil;
...
public class NinePicturesAdapter extends BaseAblistViewAdapter<String> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (TextUtils.isEmpty(url) && showAdd) {
            ImageLoaderUtils.display(mContext, imageView, R.drawable.bt_hr_add);
