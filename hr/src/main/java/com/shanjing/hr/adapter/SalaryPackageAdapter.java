 ...
 * 薪资待遇适配器
 */
public class SalaryPackageAdapter extends RecyclerView.Adapter<SalaryPackageAdapter.ViewHolder> {

    private Context context;
    private List<String> list;

    public SalaryPackageAdapter(Context context, List<String> list) {
    ...
    private SalaryPackageAdapter.OnItemClickListener mListener;

    public void setOnItemClickListener(SalaryPackageAdapter.OnItemClickListener listener) {
        this.mListener = listener;
    }

    @NonNull
    @Override
    public SalaryPackageAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_address, null, false);
        SalaryPackageAdapter.ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final SalaryPackageAdapter.ViewHolder viewHolder, int i) {
