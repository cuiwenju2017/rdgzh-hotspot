 ...
 * 融资状况适配器
 */
public class HRFinancingAdapter extends RecyclerView.Adapter<HRFinancingAdapter.ViewHolder> {
    private Context context;
    private List<String> list;

    public HRFinancingAdapter(Context context, List<String> list) {
    ...
    private HRFinancingAdapter.OnItemClickListener mListener;

    public void setOnItemClickListener(HRFinancingAdapter.OnItemClickListener listener) {
        this.mListener = listener;
    }

    @NonNull
    @Override
    public HRFinancingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_hr_financing, null, false);
        HRFinancingAdapter.ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final HRFinancingAdapter.ViewHolder viewHolder, int i) {
