 ...
 * 学历要求适配器
 */
public class EducationalRequirementsAdapter extends RecyclerView.Adapter<EducationalRequirementsAdapter.ViewHolder> {

    private Context context;
    private List<String> list;

    public EducationalRequirementsAdapter(Context context, List<String> list) {
    ...
    private EducationalRequirementsAdapter.OnItemClickListener mListener;

    public void setOnItemClickListener(EducationalRequirementsAdapter.OnItemClickListener listener) {
        this.mListener = listener;
    }

    @NonNull
    @Override
    public EducationalRequirementsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_address, null, false);
        EducationalRequirementsAdapter.ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final EducationalRequirementsAdapter.ViewHolder viewHolder, int i) {
