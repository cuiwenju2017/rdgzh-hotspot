 ...
 * 经验要求适配器
 */
public class ExperienceRequirementsAdapter extends RecyclerView.Adapter<ExperienceRequirementsAdapter.ViewHolder> {

    private Context context;
    private List<String> list;

    public ExperienceRequirementsAdapter(Context context, List<String> list) {
    ...
    private ExperienceRequirementsAdapter.OnItemClickListener mListener;

    public void setOnItemClickListener(ExperienceRequirementsAdapter.OnItemClickListener listener) {
        this.mListener = listener;
    }

    @NonNull
    @Override
    public ExperienceRequirementsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_address, null, false);
        ExperienceRequirementsAdapter.ViewHolder viewHolder = new ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull final ExperienceRequirementsAdapter.ViewHolder viewHolder, int i) {
