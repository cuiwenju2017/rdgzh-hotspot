...
import com.shanjing.hr.bean.YwpAddressBean;
...
public class AddressPickerView extends RelativeLayout implements View.OnClickListener {
    ...
    private int defaultSelectedColor = Color.parseColor("#FF0000");
    ...
    // 确定字体可以点击时候的颜色
    private int defaultSureCanClickColor = Color.parseColor("#FF0000");
    ...
    private String defaultDistrict = "区"; //显示在上面tab中的区县
