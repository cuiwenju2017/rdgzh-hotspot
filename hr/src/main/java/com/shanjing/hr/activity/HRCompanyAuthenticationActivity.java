 ...
 * 公司认证
 */
public class HRCompanyAuthenticationActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrcompany_authentication);
        initView();
    }
