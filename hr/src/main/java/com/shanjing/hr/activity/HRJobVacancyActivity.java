 ...
 * 招聘职位
 */
public class HRJobVacancyActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrjob_vacancy);
        initView();
    }
