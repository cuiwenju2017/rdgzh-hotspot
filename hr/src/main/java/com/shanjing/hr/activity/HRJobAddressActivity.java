 ...
 * 工作地点
 */
public class HRJobAddressActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrjob_address);
        initView();
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.ll_hr_back) {
            ...
            startActivity(new Intent(this, HRAddressActivity.class));
        }
    }
}
