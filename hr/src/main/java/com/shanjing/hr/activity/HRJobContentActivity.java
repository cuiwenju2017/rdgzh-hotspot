 ...
 * 工作内容
 */
public class HRJobContentActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrjob_content);
        initView();
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.ll_hr_back) {
            ...
            EventBus.getDefault().post(new HRJobContentEvent(jobContent));//保存工作内容
            finish();//关闭页面
        }
    }
