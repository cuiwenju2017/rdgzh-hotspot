 ...
 * 公司电话
 */
public class HRCompanyPhoneActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrcompany_phone);
        initView();
    }
    ...
    private void initView() {
        ...
        tv_title.setText("公司电话");
        iv.setBackgroundResource(R.drawable.hr_icon_confirm);
        tv_num.setText(Html.fromHtml("<font color='#FF0000'>" + et_name.getText().toString().length() + "</font>" + "/30"));
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.ll_hr_back) {
            finish();
        } else if (i == R.id.ll_menu) {//填写完公司电话关闭页面
            EventBus.getDefault().post(new HRCompanyPhoneEvent(et_name.getText().toString()));//保存公司名称
            finish();//关闭页面
        }
    }
}
