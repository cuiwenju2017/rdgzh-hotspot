 ...
 * 个人中心已收简历
 */
public class HRReceivedResumeActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrreceived_resume);
        initView();
    }
