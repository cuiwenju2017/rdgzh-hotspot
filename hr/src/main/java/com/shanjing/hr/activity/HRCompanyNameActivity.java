 ...
 * 公司名称
 */
public class HRCompanyNameActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrcompany_name);
        initView();
    }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.ll_hr_back) {
            ...
            EventBus.getDefault().post(new HRCompanyNameEvent(et_name.getText().toString()));//保存公司名称
            finish();//关闭页面
        }
    }
}
