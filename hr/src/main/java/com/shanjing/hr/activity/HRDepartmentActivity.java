 ...
 * 所属部门
 */
public class HRDepartmentActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrdepartment);
        initView();
    }
    ...
    private void initView() {
        ...
        tv_title.setText("所属部门");
        iv.setBackgroundResource(R.drawable.hr_icon_confirm);
        tv_num.setText(Html.fromHtml("<font color='#FF0000'>" + et_name.getText().toString().length() + "</font>" + "/10"));
        et_name.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                tv_num.setText(Html.fromHtml("<font color='#FF0000'>" + temp.length() + "</font>" + "/10"));//输入后字数显示
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.ll_hr_back) {
            finish();
        } else if (i == R.id.ll_menu) {//填写完所属部门关闭页面
            EventBus.getDefault().post(new HRDepartmentEvent(et_name.getText().toString()));//保存公司名称
            finish();//关闭页面
        }
    }
